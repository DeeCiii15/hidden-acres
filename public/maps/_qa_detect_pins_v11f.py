...
for y0, x0 in zip(ys_all, xs_all):
    ...
    if bw < 12 or bh < 6 or bw > 100 or bh > 70:
        continue
    orig = int(label[y_min : y_max + 1, x_min : x_max + 1].sum())
    if orig < 8:
        continue
    comps.append(
        dict(
